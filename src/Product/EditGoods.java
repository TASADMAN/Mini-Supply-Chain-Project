...
public class EditGoods extends JPanel implements ActionListener {
	...
	public EditGoods(Main ex9MainParam) {
		...
		setLayout(null);
		JLabel lbHeader = new JLabel("Form Edit");
		...
		btSearch.setBackground(Color.GRAY);
		...
		add(lbPrice);
		lbPrice.setForeground(Color.CYAN);
		...
		add(lbDesc);
		lbDesc.setForeground(Color.CYAN);
		...
		add(lbStock);
		lbStock.setForeground(Color.CYAN);
		...
		btAdd.setBounds(main_Menu.FRAME_WIDTH/1-188, 200, width, height);
		add(btAdd);
